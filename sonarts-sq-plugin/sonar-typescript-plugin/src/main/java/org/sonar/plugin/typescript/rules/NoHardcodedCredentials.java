...
@Rule(key = "S2068")
public class NoHardcodedCredentials extends TypeScriptRule {

  private static final String DEFAULT_CREDENTIAL_WORDS = "password,pwd,passwd";

  @RuleProperty(
    key = "credentialWords",
    description = "Comma separated list of words identifying potential credentials",
    defaultValue = DEFAULT_CREDENTIAL_WORDS)
  String credentialWords = DEFAULT_CREDENTIAL_WORDS;

  @Override
  public JsonElement configuration() {
    return ruleConfiguration((Object[]) credentialWords.split(","));
  }
