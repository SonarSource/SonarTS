...
function with_nested_class() {
  let myClass = class {
    public simple_complexity(condition: boolean): void {
      //   ^^^^^^^^^^^^^^^^^ {{Refactor this method to reduce its Cognitive Complexity from 1 to the 0 allowed.}} [[1]]
          if (condition) { }
      //  ^^ < {{+1}}
    }
  }
...
//^^^^^^^^^^^ {{Refactor this constructor to reduce its Cognitive Complexity from 1 to the 0 allowed.}} [[1]]
    if (condition) { }
  }

  get field(): string {
//    ^^^^^ {{Refactor this accessor to reduce its Cognitive Complexity from 1 to the 0 allowed.}} [[1]]
    if (this._field) {
      return this._field;
    }
    return "";
...
//^^^^^^^^ {{Refactor this function to reduce its Cognitive Complexity from 3 to the 0 allowed.}} [[3]]
    if (condition) {        // +1
    } else if (condition) { // +1
    } else {                // +1
    }
...
//^^^^^^^^ {{Refactor this function to reduce its Cognitive Complexity from 4 to the 0 allowed.}} [[4]]
  if (condition) {        // +1
//^^ < {{+1}}   
...
//^^^^^^^^ {{Refactor this function to reduce its Cognitive Complexity from 6 to the 0 allowed.}} [[6]]
  if (condition)       // +1 (nesting level +1)
...
//^^^^^^^^ {{Refactor this function to reduce its Cognitive Complexity from 17 to the 0 allowed.}} [[17]]
...
//^^^^^^^^ {{Refactor this function to reduce its Cognitive Complexity from 5 to the 0 allowed.}} [[5]]
  try {
    if (condition) { }   // +1
...
//^^^^^^^^ {{Refactor this function to reduce its Cognitive Complexity from 2 to the 0 allowed.}} [[2]]
  try {
    if (condition) { } // +1
  } finally {
    if (condition) { } // +1
...
//^^^^^^^^ {{Refactor this function to reduce its Cognitive Complexity from 1 to the 0 allowed.}} [[1]]
    if (condition) { }   // +1
  }
}
...
//^^^^^^^^ {{Refactor this function to reduce its Cognitive Complexity from 11 to the 0 allowed.}} [[11]]
  let x;
  ...
  function and_or() {
//^^^^^^^^ {{Refactor this function to reduce its Cognitive Complexity from 12 to the 0 allowed.}} [[12]]
  foo(1 && 2 && 3 && 4); // +1
