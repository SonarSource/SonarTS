...
* Collapsible "if" statements should be merged ([`no-collapsible-if-statement`])
...
[`no-collapsible-if-statement`]: ./sonarts-core/docs/rules/no-collapsible-if-statement.md
